...
<?php if ($birthdayNotification) { ?>
    <section class="birthday-employee-banner">
        <div>
            <h2>🎉 Happy Birthday, <?php echo htmlspecialchars($full_name); ?>!</h2>

            <p>
                <?php echo htmlspecialchars($birthdayNotification['birthday_message']); ?>
            </p>
    ...
    <div class="employee-column">
        <div class="panel">
            ...
            <div class="employee-action-grid">
                <a href="mytasks.php" class="employee-action-card">
                    <i class="fas fa-list-check"></i>
                    <h4>My Tasks</h4>
                    <p>Review assigned tasks and track your work progress.</p>
                </a>

                <a href="leaverequests_employee.php" class="employee-action-card purple">
                    <i class="fas fa-file-circle-check"></i>
                    <h4>Leave Requests</h4>
                    <p>Submit leave requests and follow request status.</p>
                </a>

                <a href="myattendance.php" class="employee-action-card blue">
                    <i class="fas fa-calendar-check"></i>
                    <h4>Attendance</h4>
                    <p>View your check-in, check-out, and attendance history.</p>
                </a>

                <a href="report_issue.php" class="employee-action-card orange">
