...
<meta name="description" content="OneFlow - Smart HR and Employee Management Platform" />
<meta name="keywords" content="HR platform, employee management, admin dashboard, attendance, leave requests" />
...
.hero .img.overlay:before {
  background: linear-gradient(135deg, rgba(11, 27, 50, 0.86), rgba(13, 30, 76, 0.78));
}
...
.cta-box {
  background: linear-gradient(135deg, var(--oneflow-primary), var(--oneflow-dark-blue));
  border-radius: 24px;
  padding: 50px 30px;
  text-align: center;
  color: white;
...
@keyframes lineReveal {
  0% { opacity: 0; transform: translateY(70px); filter: blur(8px); letter-spacing: 1px; }
    ...
    <div class="row justify-content-center align-items-center">
      <div class="col-lg-10 text-center">
        ...
        <p class="hero-subtitle">
          OneFlow helps organizations manage employees, attendance, leave requests,
          HR tasks, team leader operations, IT support, and admin control through one smart platform.
        </p>
    ...
    <div class="row justify-content-center text-center mb-5">
      <div class="col-lg-8">
        ...
        <p class="section-subtitle">
          Designed to support modern teams with a smooth, organized, and professional employee management experience.
        </p>
      </div>
    </div>
    ...
    <div class="row g-4">
      <div class="col-md-6 col-lg-4" data-aos="fade-up">
        <div class="feature-card">
          ...
          <p>Monitor employee attendance, check-ins, work hours, late arrivals, and overtime from one dashboard.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="feature-card">
          ...
          <p>Employees can submit leave requests while HR reviews, approves, or rejects them efficiently.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
        <div class="feature-card">
          ...
          <p>Store employee information, salary, birth date, status, and work records in one secure place.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4" data-aos="fade-up">
        <div class="feature-card">
          ...
          <p>Team Leaders can assign tasks, monitor progress, review submissions, and send feedback.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="feature-card">
          ...
          <h3>Smart Meetings</h3>
          <p>Schedule meetings based on team availability and employee schedules to avoid conflicts.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
        <div class="feature-card">
          ...
          <p>Give management clear insights into attendance, tasks, users, requests, and team performance.</p>
        </div>
      </div>
    </div>
  </div>
...
<section id="roles" class="section roles-section">
  <div class="container">
    <div class="row justify-content-center text-center mb-5">
      <div class="col-lg-8">
        <h2 class="section-title">All Roles in OneFlow</h2>
        <p class="section-subtitle">
          OneFlow provides dedicated dashboards and permissions for each user type inside the organization.
        </p>
      </div>
    </div>
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-md-6 col-lg-4" data-aos="fade-up">
        <div class="role-card">
          ...
          <h3>Admin</h3>
          <p>Controls users, roles, account status, system access, inventory, analytics, and overall platform settings.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="role-card">
          ...
          <h3>HR</h3>
          <p>Manages employees, attendance records, leave requests, recruitment, HR notes, and workforce updates.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
        <div class="role-card">
          ...
          <h3>Employee</h3>
          <p>Views tasks, attendance, schedule, leave requests, notifications, and submits work to the Team Leader.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4" data-aos="fade-up">
        <div class="role-card">
          ...
          <h3>Team Leader</h3>
          <p>Views team members, assigns tasks, tracks progress, schedules meetings, and reviews employee submissions.</p>
        </div>
      </div>

      <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="role-card">
          <div class="role-icon">IT</div>
          <h3>IT Support</h3>
          <p>Handles technical issues, support tickets, system requests, and helps maintain smooth platform operations.</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="section">
  <div class="container">
    <div class="cta-box" data-aos="fade-up">
      ...
      <p>
        Start with a clean landing page experience, then connect it to login,
        access requests, recruitment, and role-based dashboards for a complete management platform.
      </p>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-4">
        <div class="widget">
          <h3>OneFlow</h3>
          <p>A smart HR and employee management platform designed to simplify internal processes and improve organization workflow.</p>
        </div>
      </div>
